#############################################################################
# Makefile for building: kylin-scanner
# Generated by qmake (3.1) (Qt 5.12.8)
# Project:  kylin-scanner.pro
# Template: subdirs
# Command: /usr/lib/qt5/bin/qmake -o Makefile kylin-scanner.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = kylin-scanner1.0.0
DISTDIR = /home/yusq/rpmbuild/kylin-scanner/.tmp/kylin-scanner1.0.0
SUBTARGETS    =  \
		sub-src-src-pro


sub-src-src-pro-qmake_all:  FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && $(QMAKE) -o Makefile /home/yusq/rpmbuild/kylin-scanner/src/src.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
	cd src/ && $(MAKE) -f Makefile qmake_all
sub-src-src-pro: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/yusq/rpmbuild/kylin-scanner/src/src.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile
sub-src-src-pro-make_first: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/yusq/rpmbuild/kylin-scanner/src/src.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile 
sub-src-src-pro-all: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/yusq/rpmbuild/kylin-scanner/src/src.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile all
sub-src-src-pro-clean: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/yusq/rpmbuild/kylin-scanner/src/src.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile clean
sub-src-src-pro-distclean: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/yusq/rpmbuild/kylin-scanner/src/src.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile distclean
sub-src-src-pro-install_subtargets: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/yusq/rpmbuild/kylin-scanner/src/src.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile install
sub-src-src-pro-uninstall_subtargets: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/yusq/rpmbuild/kylin-scanner/src/src.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile uninstall

Makefile: kylin-scanner.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		kylin-scanner.pro
	$(QMAKE) -o Makefile kylin-scanner.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
...
qmake_all: sub-src-src-pro-qmake_all FORCE

make_first: sub-src-src-pro-make_first  FORCE
all: sub-src-src-pro-all  FORCE
clean: sub-src-src-pro-clean  FORCE
distclean: sub-src-src-pro-distclean  FORCE
	-$(DEL_FILE) Makefile
	-$(DEL_FILE) .qmake.stash
install_subtargets: sub-src-src-pro-install_subtargets FORCE
uninstall_subtargets: sub-src-src-pro-uninstall_subtargets FORCE

sub-src-src-pro-check:
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/yusq/rpmbuild/kylin-scanner/src/src.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile check
check: sub-src-src-pro-check

sub-src-src-pro-benchmark:
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/yusq/rpmbuild/kylin-scanner/src/src.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile benchmark
benchmark: sub-src-src-pro-benchmark
